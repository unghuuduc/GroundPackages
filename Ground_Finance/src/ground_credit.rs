//! # [GroundCredit]: Make a Credit Ground for your journey into Web 3!
//!
...
blueprint! {
    ...
    impl GroundCredit {
        ...
        /// - identity_sbt: the unique ID resource address which the component initializer use.
        /// ### Output: 
        /// Component address.
