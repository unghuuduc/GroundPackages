//! # [GroundLending]: Make a Ground for your Web 3 Finance!
//!
...
pub struct Lender {
    ...
    /// 
    /// Lenders are only eligible for any borrow made after this time data.
    start_time: u64
...
blueprint! {
    ...
    impl GroundLending {
        ...
        /// This method is for users to lend their stable coin to the protocol and get the lending badge to become protocol's lenders.
        ...
        /// This method is for lenders to burn their lending NFT and withdraw all their return amount from the protocol
